...
const MODUL = [
  ...
  { st:'Sudah jalan', stEn:'Running', jalan:true, nama:'Personel dan Lisensi', namaEn:'Personnel and Licences',
    ket:'Lisensi, rating, dan sertifikat tiap orang beserta masa berlakunya, lengkap dengan pindaian buktinya. Yang tinggal dua bulan atau kurang menyala di beranda dan di lonceng akun orangnya sendiri.',
    ketEn:'Each person’s licences, ratings, and certificates with their validity, scanned proof included. Anything with two months or less left lights up on the home screen and in that person’s own notification bell.' },
