...
const KAMUS = {
  id: {
    ...
    /* daily check */
    dcJudul:'Daily Check', dcSub:'Klik status untuk mengubah kondisi: Normal → Alarm → Gangguan.',
 ...
 modalPasswd:'Setel Ulang Password',
    ...
    /* slot TTD banyak — untuk pejabat/admin (PH Manajer Teknik) */
    ttdSayaLabelJudul:'Label slot (mis. "MT asli" atau "PH Bagus")',
    ttdSayaLabelPh:'mis. PH Bagus',
    ttdSayaLabelWajib:'Beri label untuk slot ini — supaya tahu TTD siapa yang dipakai.',
    ttdSayaGambarSlotBaru:'Gambar tanda tangan untuk slot baru',
    ttdSayaTambahSlot:'➕ Tambah slot',
    ttdSayaCatatanBanyak:'Akun Anda boleh memegang beberapa TTD tersimpan — mis. TTD Manajer Teknik asli dan tiap PH yang menggantikannya. Saat menandatangani catatan, Anda memilih slot mana yang dipakai. Menghapus slot tidak mempengaruhi tanda tangan yang sudah terlanjur dibubuhkan pada catatan.',
    ttdSlotTersimpan:'Slot tersimpan',
    ttdSlotBatas:'3',
    ttdSlotKosong:'— belum ada slot TTD —',
    ttdSlotTanpaLabel:'(tanpa label)',
    ttdSlotDitambahkan:'Slot TTD ditambahkan.',
    ttdSlotDihapus:'Slot TTD dihapus.',
    ttdSlotHapusTanya:'Hapus slot "{label}"? Tanda tangan yang sudah dibubuhkan pada catatan tidak ikut terhapus.',
    ttdSlotPilihJudul:'Pilih tanda tangan',
    ttdSlotPilihKeterangan:'Pilih slot yang akan dipakai. Yang terakhir dipilih otomatis jadi urutan pertama pada pemakaian berikutnya.',
  ...
  en: {
    ...
    dcJudul:'Daily Check', dcSub:'Click a status to change it: Normal → Alarm → Fault.',
 ...
 modalPasswd:'Reset Password',
    ...
    /* multi-slot signatures — for officers/admin (Duty-Manager rotations) */
    ttdSayaLabelJudul:'Slot label (e.g. "MT actual" or "PH Bagus")',
    ttdSayaLabelPh:'e.g. Duty MT Bagus',
    ttdSayaLabelWajib:'Give this slot a label — so it is clear whose signature is being used.',
    ttdSayaGambarSlotBaru:'Draw the signature for a new slot',
    ttdSayaTambahSlot:'➕ Add slot',
    ttdSayaCatatanBanyak:'Your account may hold several saved signatures — e.g. the Manager Teknik’s own signature and each duty officer standing in. When signing a record, you pick which slot to use. Deleting a slot does not affect signatures already placed on records.',
    ttdSlotTersimpan:'Saved slots',
    ttdSlotBatas:'3',
    ttdSlotKosong:'— no signature slots yet —',
    ttdSlotTanpaLabel:'(no label)',
    ttdSlotDitambahkan:'Signature slot added.',
    ttdSlotDihapus:'Signature slot deleted.',
    ttdSlotHapusTanya:'Delete slot "{label}"? Signatures already placed on records are not removed.',
    ttdSlotPilihJudul:'Pick a signature',
    ttdSlotPilihKeterangan:'Choose the slot to use. The one you pick moves to the top for next time.',
  ...
  es: {
    ...
    /* chequeo diario */
    dcJudul:'Chequeo Diario', dcSub:'Pulse un estado para cambiarlo: Normal → Alarma → Avería.',
 ...
 modalPasswd:'Restablecer Contraseña',
    ...
    /* firmas multi-slot — para directivos/administradores (rotaciones de PH) */
    ttdSayaLabelJudul:'Etiqueta del slot (p. ej. "MT titular" o "PH Bagus")',
    ttdSayaLabelPh:'p. ej. PH Bagus',
    ttdSayaLabelWajib:'Ponga una etiqueta al slot — para saber de quién es la firma que se usa.',
    ttdSayaGambarSlotBaru:'Dibuje la firma para un slot nuevo',
    ttdSayaTambahSlot:'➕ Añadir slot',
    ttdSayaCatatanBanyak:'Su cuenta puede guardar varias firmas — p. ej. la del Manager Teknik titular y la de cada PH que lo sustituye. Al firmar un registro, elige qué slot usar. Borrar un slot no afecta las firmas ya puestas en los registros.',
    ttdSlotTersimpan:'Slots guardados',
    ttdSlotBatas:'3',
    ttdSlotKosong:'— aún no hay slots de firma —',
    ttdSlotTanpaLabel:'(sin etiqueta)',
    ttdSlotDitambahkan:'Slot de firma añadido.',
    ttdSlotDihapus:'Slot de firma borrado.',
    ttdSlotHapusTanya:'¿Borrar el slot "{label}"? Las firmas ya puestas en los registros no se eliminan.',
    ttdSlotPilihJudul:'Elija una firma',
    ttdSlotPilihKeterangan:'Elija el slot a usar. El que elija pasa al primer lugar para la próxima vez.',
