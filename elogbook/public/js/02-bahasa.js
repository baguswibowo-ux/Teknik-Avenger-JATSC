...
const KAMUS = {
  id: {
    ...
    /* isu dari catatan logbook */
    buatIsuBtn:'⚠ Buat Isu', buatIsuDariCatatan:'Buat isu dari catatan ini',
    isuDariLogbookKet:'Diisi otomatis dari catatan Logbook Fasilitas', isuDariLogbookSunting:'Periksa dan sunting seperlunya sebelum disimpan. Menutup isu tetap dilakukan manual.',
    sumberLogbook:'Sumber: Logbook Fasilitas', takBolehBuatIsu:'Peran Anda tidak bisa membuat isu.',
    /* tautan dokumen pada catatan logbook */
    tautanDokumen:'Tautan Dokumen', tautkanDokumen:'+ Tautkan Dokumen', pilihDokumen:'Tautkan Dokumen',
    cariDokumen:'Cari dokumen...', selesai:'Selesai',
    belumAdaTautan:'Belum ada dokumen yang ditautkan.',
    tautanBelumAdaDokumen:'Belum ada dokumen jenis ini di unit Anda.',
    tautanPenuh:'Maksimal {n} tautan dokumen per catatan.',
    lepasTautan:'Lepas tautan', bukaDokumenIni:'Buka dokumen ini',
    dokumenGagalDibuka:'Dokumennya tidak bisa dibuka — mungkin sudah dihapus.',
    tautanJenisLtk:'LTK', tautanJenisBapb:'BAPB', tautanJenisBerkala:'Berkala',
    buatCatatanLogbook:'✎ Buat Catatan Logbook',
    catatanDariDokumenKet:'Dokumennya sudah ditautkan di bawah. Uraian pekerjaannya tetap Anda tulis sendiri.',
    takBolehTulis:'Peran Anda tidak bisa menambah catatan.',
    rujukan:'Rujukan',
    mengambilLampiranLogbook:'Mengambil lampiran dari logbook…', lampiranDariLogbook:'lampiran diambil dari logbook', lampiranLogbookGagal:'gagal diambil — lampirkan ulang secara manual.',
 ...
 modalPasswd:'Setel Ulang Password',
    ...
    tabMeter:'📟 METER READING',
    noteCariMr:'Menampilkan 7 hari terakhir; catatan lebih lama disembunyikan — pilih tanggal atau ↺ Tampilkan Semua untuk memanggilnya.',
    /* ---------- Pemeliharaan Listrik & Mekanik (js/17g) ----------
       Tujuh lembar, satu sub-tab per kegiatan. Judul lembar di modal & cetak
       memakai judul resmi formulirnya (bahasa Indonesia apa adanya, sama
       seperti Weekly Check) — yang diterjemahkan di sini teks antarmukanya. */
    tabMlPaneldist:'🔲 PANEL DISTRIBUSI', tabMlSts:'⚡ MAINT STS', tabMlUps:'🔋 MAINT UPS',
    tabMlChiller:'❄ CHILLER', tabMlAhu:'🌀 AHU', tabMlGenset:'🛢 GENSET',
    tabMlGrounding:'⚡ GROUNDING & PETIR',
    mlJudul_paneldist:'Panel Distribusi', mlJudul_sts:'STS', mlJudul_ups:'UPS',
    mlJudul_chiller:'Chiller', mlJudul_ahu:'AHU', mlJudul_genset:'Genset',
    mlJudul_grounding:'Grounding & Petir',
    mlSub_paneldist:'Pemeliharaan rutin — tegangan, arus, frekuensi, dan temperatur tiap panel.',
    mlSub_sts:'Pemeliharaan bulanan — sembilan lokasi × STS Line 1 / Line 2 / Output.',
    mlSub_ups:'Pemeliharaan rutin — rectifier, inverter, baterai; ada tabel tambahan tegangan sel baterai.',
    mlSub_chiller:'Tiga chiller, empat pompa distribusi, dua pompa chiller.',
    mlSub_ahu:'Lima slot Air Handling Unit — ampere motor, tekanan & temperatur air, bearing.',
    mlSub_genset:'PLN, stabilizer, genset, tangki, battery, dan cadangan.',
    mlSub_grounding:'Checklist visual penangkal petir plus pengukuran tahanan pembumian.',
    tambahMl:'+ Form Baru', simpanMl:'💾 Simpan Lembar Pemeliharaan',
    noteCariMl:'Menampilkan 7 hari terakhir; catatan lebih lama disembunyikan — pilih tanggal atau ↺ Tampilkan Semua untuk memanggilnya.',
    mlBelumAda:'Belum ada lembar pemeliharaan.', mlTersimpan:'Lembar pemeliharaan tersimpan.',
    mlTambahKolom:'+ Kolom', mlTambahBat:'+ Tabel Baterai',
    mlBatKosong:'Belum ada tabel baterai. Tekan "+ Tabel Baterai" untuk menambah satu blok — tiap blok punya nama UPS, merk, tipe, dan jumlah selnya sendiri.',
    mlUps:'UPS', mlMerkBaterai:'Merk Baterai', mlTipe:'Tipe', mlJumlahSel:'Jumlah sel',
    ...
    tabRkMing:'📻 MINGGUAN', tabRkBul:'📻 BULANAN', tabRkRstx:'📡 RADIO R&S TX', tabRkRsrx:'📡 RADIO R&S RX',
    tabRkBattery:'🔋 BATTERY', tabRkTxvhf:'📶 TX VHF', tabRkAntvhf:'🗼 ANTENA VHF',
    rkSub_ming:'Meter Reading Radio VHF A/G — pemeliharaan mingguan. Isi apa adanya sesuai pembacaan alat ukur.',
    rkSub_bul:'Meter Reading Radio VHF A/G — pemeliharaan bulanan, ditambah pengukuran catu daya.',
    rkJudul_rstx:'Radio R&S TX', rkSub_rstx:'Meter Reading Transmitter HF MWARA R&S — Gedung 710.',
    rkJudul_rsrx:'Radio R&S RX', rkSub_rsrx:'Meter Reading Receiver HF MWARA R&S — Gedung 720.',
    rkJudul_battery:'Battery & Charger', rkSub_battery:'Pengukuran tegangan battery (charge / discharge) dan kondisi charger.',
    rkJudul_txvhf:'TX VHF', rkSub_txvhf:'Preventive maintenance Transmitter VHF — semesteran; P Out, P Ref, dan VSWR memakai alat ukur.',
    rkJudul_antvhf:'Antena VHF', rkSub_antvhf:'Preventive maintenance Antena VHF — tahunan; tiang, labrang, konektor & surge protection.',
    tambahRk:'+ Form Baru', simpanRk:'💾 Simpan Meter Reading',
    noteCariRk:'Menampilkan 7 hari terakhir; catatan lebih lama disembunyikan — pilih tanggal atau ↺ Tampilkan Semua untuk memanggilnya.',
    rkBelumAda:'Belum ada lembar meter reading.', rkTersimpan:'Lembar meter reading tersimpan.',
    rkNilaiTercatat:'nilai tercatat', rkPerluPerbaikan:'perlu perbaikan', rkLokasi:'Lokasi',
    rkSunting:'Sunting lembar ini',
    rkTerkunci:'Sudah ditandatangani manager teknik — tidak bisa disunting lagi.',
    ...
    labelLampiranBapb:'Lampiran — Foto / Dokumen Pendukung <span style="text-transform:none;letter-spacing:0;">(opsional)</span>',
    bapbKelolaLampiran:'📎 Kelola lampiran', bapbKelolaLampiranJudul:'Lampiran BAPB',
    bapbLampiranTersimpan:'Lampiran tersimpan', bapbLampiranTambah:'Tambah berkas',
    bapbLampiranKosong:'Belum ada lampiran.', bapbLampiranTakBerubah:'Tidak ada yang diubah.',
    ...
    hanyaAdminHapus:'Hanya administrator atau admin unit yang bisa menghapus.',
    hanyaAdminUbah:'Hanya administrator atau admin unit yang bisa mengubah isu.',
  ...
  en: {
    ...
    /* issue from a logbook entry */
    buatIsuBtn:'⚠ Create Issue', buatIsuDariCatatan:'Create an issue from this entry',
    isuDariLogbookKet:'Pre-filled from the Facility Logbook entry of', isuDariLogbookSunting:'Review and edit as needed before saving. Closing the issue stays manual.',
    sumberLogbook:'Source: Facility Logbook', takBolehBuatIsu:'Your role cannot create issues.',
    /* document links on a logbook entry */
    tautanDokumen:'Document Links', tautkanDokumen:'+ Link a Document', pilihDokumen:'Link a Document',
    cariDokumen:'Search documents...', selesai:'Done',
    belumAdaTautan:'No documents linked yet.',
    tautanBelumAdaDokumen:'No documents of this kind in your unit yet.',
    tautanPenuh:'At most {n} document links per entry.',
    lepasTautan:'Remove link', bukaDokumenIni:'Open this document',
    dokumenGagalDibuka:'That document could not be opened — it may have been deleted.',
    tautanJenisLtk:'LTK', tautanJenisBapb:'BAPB', tautanJenisBerkala:'Periodic',
    buatCatatanLogbook:'✎ Create Logbook Entry',
    catatanDariDokumenKet:'The document is linked below. The work description is still yours to write.',
    takBolehTulis:'Your role cannot add entries.',
    rujukan:'Ref',
    mengambilLampiranLogbook:'Fetching attachments from the logbook…', lampiranDariLogbook:'attachment(s) taken from the logbook', lampiranLogbookGagal:'could not be fetched — attach them manually.',
 ...
 modalPasswd:'Reset Password',
    ...
    tabMeter:'📟 METER READING',
    noteCariMr:'Showing the last 7 days; older records are hidden — pick a date or ↺ Show All to recall them.',
    /* ---------- Electrical & Mechanical maintenance (js/17g) ---------- */
    tabMlPaneldist:'🔲 DISTRIBUTION PANEL', tabMlSts:'⚡ STS MAINT', tabMlUps:'🔋 UPS MAINT',
    tabMlChiller:'❄ CHILLER', tabMlAhu:'🌀 AHU', tabMlGenset:'🛢 GENERATOR',
    tabMlGrounding:'⚡ GROUNDING & LIGHTNING',
    mlJudul_paneldist:'Distribution Panel', mlJudul_sts:'STS', mlJudul_ups:'UPS',
    mlJudul_chiller:'Chiller', mlJudul_ahu:'AHU', mlJudul_genset:'Generator',
    mlJudul_grounding:'Grounding & Lightning',
    mlSub_paneldist:'Routine maintenance — voltage, current, frequency, and temperature per panel.',
    mlSub_sts:'Monthly maintenance — nine locations × STS Line 1 / Line 2 / Output.',
    mlSub_ups:'Routine maintenance — rectifier, inverter, battery; includes an extra battery-cell voltage table.',
    mlSub_chiller:'Three chillers, four distribution pumps, two chiller pumps.',
    mlSub_ahu:'Five Air Handling Unit slots — motor current, water pressure & temperature, bearings.',
    mlSub_genset:'Mains, stabiliser, generator, tanks, battery, and reserves.',
    mlSub_grounding:'Lightning-protection visual checklist plus earthing resistance measurement.',
    tambahMl:'+ New Form', simpanMl:'💾 Save Maintenance Sheet',
    noteCariMl:'Showing the last 7 days; older records are hidden — pick a date or ↺ Show All to recall them.',
    mlBelumAda:'No maintenance sheets yet.', mlTersimpan:'Maintenance sheet saved.',
    mlTambahKolom:'+ Column', mlTambahBat:'+ Battery Table',
    mlBatKosong:'No battery table yet. Press "+ Battery Table" to add a block — each block has its own UPS name, brand, type, and cell count.',
    mlUps:'UPS', mlMerkBaterai:'Battery Brand', mlTipe:'Type', mlJumlahSel:'Cells',
    ...
    tabRkMing:'📻 WEEKLY', tabRkBul:'📻 MONTHLY', tabRkRstx:'📡 R&S RADIO TX', tabRkRsrx:'📡 R&S RADIO RX',
    tabRkBattery:'🔋 BATTERY', tabRkTxvhf:'📶 VHF TX', tabRkAntvhf:'🗼 VHF ANTENNA',
    rkSub_ming:'VHF A/G radio meter reading — weekly maintenance. Record the meter readings as they are.',
    rkSub_bul:'VHF A/G radio meter reading — monthly maintenance, plus power-supply measurements.',
    rkJudul_rstx:'R&S Radio TX', rkSub_rstx:'R&S HF MWARA transmitter meter reading — Building 710.',
    rkJudul_rsrx:'R&S Radio RX', rkSub_rsrx:'R&S HF MWARA receiver meter reading — Building 720.',
    rkJudul_battery:'Battery & Charger', rkSub_battery:'Battery voltage (charge / discharge) and charger condition.',
    rkJudul_txvhf:'VHF TX', rkSub_txvhf:'VHF transmitter preventive maintenance — semi-annual; P Out, P Ref, and VSWR with test equipment.',
    rkJudul_antvhf:'VHF Antenna', rkSub_antvhf:'VHF antenna preventive maintenance — annual; mast, guy wires, connectors & surge protection.',
    tambahRk:'+ New Form', simpanRk:'💾 Save Meter Reading',
    noteCariRk:'Showing the last 7 days; older records are hidden — pick a date or ↺ Show All to recall them.',
    rkBelumAda:'No meter reading sheets yet.', rkTersimpan:'Meter reading sheet saved.',
    rkNilaiTercatat:'values recorded', rkPerluPerbaikan:'need repair', rkLokasi:'Location',
    rkSunting:'Edit this sheet',
    rkTerkunci:'Already signed by the technical manager — it can no longer be edited.',
    ...
    labelLampiranBapb:'Attachments — Supporting Photo / Document <span style="text-transform:none;letter-spacing:0;">(optional)</span>',
    bapbKelolaLampiran:'📎 Manage attachments', bapbKelolaLampiranJudul:'BAPB attachments',
    bapbLampiranTersimpan:'Saved attachments', bapbLampiranTambah:'Add files',
    bapbLampiranKosong:'No attachments yet.', bapbLampiranTakBerubah:'Nothing was changed.',
    ...
    hanyaAdminHapus:'Only an administrator or unit admin can delete.',
    hanyaAdminUbah:'Only an administrator or unit admin can edit issues.',
  ...
  es: {
    ...
    /* incidencia desde una anotación de la bitácora */
    buatIsuBtn:'⚠ Crear Incidencia', buatIsuDariCatatan:'Crear una incidencia desde esta anotación',
    isuDariLogbookKet:'Rellenado automáticamente desde la anotación de la Bitácora del', isuDariLogbookSunting:'Revise y edite si es necesario antes de guardar. El cierre de la incidencia sigue siendo manual.',
    sumberLogbook:'Fuente: Bitácora de Instalaciones', takBolehBuatIsu:'Su rol no puede crear incidencias.',
    /* enlaces de documentos en una anotación */
    tautanDokumen:'Documentos Enlazados', tautkanDokumen:'+ Enlazar Documento', pilihDokumen:'Enlazar Documento',
    cariDokumen:'Buscar documentos...', selesai:'Listo',
    belumAdaTautan:'Aún no hay documentos enlazados.',
    tautanBelumAdaDokumen:'Aún no hay documentos de este tipo en su unidad.',
    tautanPenuh:'Máximo {n} documentos enlazados por anotación.',
    lepasTautan:'Quitar enlace', bukaDokumenIni:'Abrir este documento',
    dokumenGagalDibuka:'No se pudo abrir el documento — puede que ya esté eliminado.',
    tautanJenisLtk:'LTK', tautanJenisBapb:'BAPB', tautanJenisBerkala:'Periódico',
    buatCatatanLogbook:'✎ Crear Anotación',
    catatanDariDokumenKet:'El documento queda enlazado abajo. La descripción del trabajo sigue siendo suya.',
    takBolehTulis:'Su rol no puede añadir anotaciones.',
    rujukan:'Ref',
    mengambilLampiranLogbook:'Obteniendo adjuntos de la bitácora…', lampiranDariLogbook:'adjunto(s) tomados de la bitácora', lampiranLogbookGagal:'no se pudieron obtener — adjúntelos manualmente.',
 ...
 modalPasswd:'Restablecer Contraseña',
    ...
    tabMeter:'📟 METER READING',
    noteCariMr:'Muestra los últimos 7 días; los registros más antiguos se ocultan — elija una fecha o ↺ Mostrar Todo para recuperarlos.',
    /* trabajos periódicos */
    ...
    labelLampiranBapb:'Adjuntos — Foto / Documento de Apoyo <span style="text-transform:none;letter-spacing:0;">(opcional)</span>',
    bapbKelolaLampiran:'📎 Gestionar adjuntos', bapbKelolaLampiranJudul:'Adjuntos del BAPB',
    bapbLampiranTersimpan:'Adjuntos guardados', bapbLampiranTambah:'Añadir archivos',
    bapbLampiranKosong:'Aún no hay adjuntos.', bapbLampiranTakBerubah:'No se cambió nada.',
    ...
    hanyaAdminHapus:'Solo un administrador o administrador de unidad puede borrar.',
    hanyaAdminUbah:'Solo un administrador o administrador de unidad puede editar incidencias.',
    ...
    /* ---------- Mantenimiento eléctrico y mecánico (js/17g) ---------- */
    tabMlPaneldist:'🔲 CUADRO DE DISTRIBUCIÓN', tabMlSts:'⚡ MANT. STS', tabMlUps:'🔋 MANT. SAI',
    tabMlChiller:'❄ ENFRIADORA', tabMlAhu:'🌀 UTA', tabMlGenset:'🛢 GRUPO ELECTRÓGENO',
    tabMlGrounding:'⚡ PUESTA A TIERRA Y PARARRAYOS',
    mlJudul_paneldist:'Cuadro de Distribución', mlJudul_sts:'STS', mlJudul_ups:'SAI',
    mlJudul_chiller:'Enfriadora', mlJudul_ahu:'UTA', mlJudul_genset:'Grupo Electrógeno',
    mlJudul_grounding:'Puesta a Tierra y Pararrayos',
    mlSub_paneldist:'Mantenimiento rutinario — tensión, corriente, frecuencia y temperatura por cuadro.',
    mlSub_sts:'Mantenimiento mensual — nueve ubicaciones × STS Línea 1 / Línea 2 / Salida.',
    mlSub_ups:'Mantenimiento rutinario — rectificador, inversor, batería; incluye una tabla extra de tensión por celda.',
    mlSub_chiller:'Tres enfriadoras, cuatro bombas de distribución, dos bombas de enfriadora.',
    mlSub_ahu:'Cinco unidades de tratamiento de aire — corriente del motor, presión y temperatura del agua, rodamientos.',
    mlSub_genset:'Red, estabilizador, grupo electrógeno, depósitos, batería y reservas.',
    mlSub_grounding:'Lista visual de protección contra rayos más medición de resistencia de tierra.',
    tambahMl:'+ Nuevo Formulario', simpanMl:'💾 Guardar Hoja de Mantenimiento',
    noteCariMl:'Mostrando los últimos 7 días; las anotaciones más antiguas están ocultas — elija una fecha o ↺ Mostrar Todo para recuperarlas.',
    mlBelumAda:'Aún no hay hojas de mantenimiento.', mlTersimpan:'Hoja de mantenimiento guardada.',
    mlTambahKolom:'+ Columna', mlTambahBat:'+ Tabla de Baterías',
    mlBatKosong:'Aún no hay tabla de baterías. Pulse "+ Tabla de Baterías" para añadir un bloque — cada bloque tiene su propio nombre de SAI, marca, tipo y número de celdas.',
    mlUps:'SAI', mlMerkBaterai:'Marca de Batería', mlTipe:'Tipo', mlJumlahSel:'Celdas',
    ...
    tabRkMing:'📻 SEMANAL', tabRkBul:'📻 MENSUAL', tabRkRstx:'📡 RADIO R&S TX', tabRkRsrx:'📡 RADIO R&S RX',
    tabRkBattery:'🔋 BATERÍA', tabRkTxvhf:'📶 TX VHF', tabRkAntvhf:'🗼 ANTENA VHF',
    rkSub_ming:'Lectura de medidores radio VHF A/G — mantenimiento semanal. Anote las lecturas tal como aparecen.',
    rkSub_bul:'Lectura de medidores radio VHF A/G — mantenimiento mensual, más medición de alimentación.',
    rkJudul_rstx:'Radio R&S TX', rkSub_rstx:'Lectura de medidores transmisor HF MWARA R&S — Edificio 710.',
    rkJudul_rsrx:'Radio R&S RX', rkSub_rsrx:'Lectura de medidores receptor HF MWARA R&S — Edificio 720.',
    rkJudul_battery:'Batería y Cargador', rkSub_battery:'Tensión de batería (carga / descarga) y estado del cargador.',
    rkJudul_txvhf:'TX VHF', rkSub_txvhf:'Mantenimiento preventivo del transmisor VHF — semestral; P Out, P Ref y VSWR con instrumento.',
    rkJudul_antvhf:'Antena VHF', rkSub_antvhf:'Mantenimiento preventivo de la antena VHF — anual; mástil, vientos, conectores y protección contra sobretensiones.',
    tambahRk:'+ Formulario Nuevo', simpanRk:'💾 Guardar Lectura',
    noteCariRk:'Mostrando los últimos 7 días; las anotaciones más antiguas están ocultas — elija una fecha o ↺ Mostrar Todo para recuperarlas.',
    rkBelumAda:'Aún no hay hojas de lectura.', rkTersimpan:'Hoja de lectura guardada.',
    rkNilaiTercatat:'valores registrados', rkPerluPerbaikan:'requieren reparación', rkLokasi:'Ubicación',
    rkSunting:'Editar esta hoja',
    rkTerkunci:'Ya está firmada por el gerente técnico — no se puede editar.',
